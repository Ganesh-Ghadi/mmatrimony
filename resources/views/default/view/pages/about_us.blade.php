                    ...
                    <div class="col-lg-12">
                        <div class="row g-4 align-items-center">
                            <div class="col-lg-7 wow fadeInUp" data-wow-delay="0.3s">
                                ...
                                <div class="d-flex">
                                    <div class="my-auto">
                                        <b><h1  style="font-weight: bold; font-size: 20px; ">Welcome to Maratha Vivah Mandal Dombivli !!!</h1></b>
                                        
                                    <p1 style="color: black; margin-left: 30px;"> Maratha Vivah Mandal Dombivli is a community-driven organization dedicated to facilitating successful matrimonial alliances within the Maratha community. Established with the vision to preserve cultural heritage and strengthen bonds, we aim to provide a reliable and respectful platform for individuals and families looking for compatible life partners.</p1>
                                    <br><br>
                                    <p2 style="color: black; margin-left: 30px;"> Our mission is to make the process of finding a life partner simpler, more accessible, and culturally aligned with Maratha values and traditions. We understand the importance of family and tradition in the Maratha community, and with this in mind, we ensure a personalized approach to matchmaking that respects the diverse aspirations, backgrounds, and preferences of individuals.</p2>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-5 wow fadeInUp order-first order-md-last" data-wow-delay="0.3s">
                                <img src="{{asset('assets/images/aboutbanner.jpg')}}" alt="Maratha Vivah Mandal, Dombivili" class="about-image" style="width: 400px; height: 400px;">
                            </div>
            ...
            <div class="container position-relative py-5">
                ...
                <div class="story-timeline">
                    <div class="row wow fadeInUp" data-wow-delay="0.2s">
                        <div class="col-md-6 text-end border-0 border-top border-end border-secondary p-4">
                            <div class="d-inline-flex align-items-center h-100">
                                <img src="{{asset('assets/images/KundaliMatching.jpeg')}}" alt="Maratha Vivah Mandal, Dombivili" class="about-image" style="width: 300px; height: 300px;">
                            </div>
                        </div>
                    ...
                    <div class="row flex-column-reverse flex-md-row wow fadeInUp" data-wow-delay="0.3s">
                        <div class="col-md-6 text-end border-end border-top border-secondary p-4 ps-0">
                            <div class="h-100 d-flex flex-column justify-content-center bg-secondary p-4">
                                ...
                                <p><span style="color: black; font-weight: bold;">Cultural Preservation:</span> At Maratha Vivah Mandal Dombivli, we believe in upholding the rich traditions and values of the Maratha community, ensuring that matrimonial decisions reflect both modern aspirations and ancestral values.</p>
                        ...
                        <div class="col-md-6 border-start border-top border-secondary p-4">
                            <div class="d-inline-flex align-items-center h-100">
                                <div class="d-inline-flex align-items-center h-100">
                                    <img src="{{asset('assets/images/OurValues.jpeg')}}" alt="Maratha Vivah Mandal, Dombivili" class="about-image" style="width: 300px; height: 300px;">
                                </div>   
                             </div>
                        </div>
                    </div>
                    <div class="row wow fadeInUp" data-wow-delay="0.4s">
                        <div class="col-md-6 text-end border-end border-top border-secondary p-4 ps-0">
                            <div class="d-inline-flex align-items-center h-100">
                                <img src="{{asset('assets/images/whychooseus.jpeg')}}" alt="Maratha Vivah Mandal, Dombivili" class="about-image" style="width: 300px; height: 300px;">
                            </div> 
                        </div>
                        <div class="col-md-6 border-start border-top border-secondary p-4 pe-0">
                            <div class="h-100 d-flex flex-column justify-content-center bg-secondary p-4">
                                ...
                                <p><span style="color: black; font-weight: bold;">Proven Success:</span> Over the years, Maratha Vivah Mandal Dombivli has helped many families successfully find life partners, making us a trusted name in the Maratha matrimonial community.</p>
                            </div>
                        </div>
                    </div>
                    {{-- <div class="row flex-column-reverse flex-md-row wow fadeInUp" data-wow-delay="0.5s">
                        ...
                        <div class="col-md-6 border border-end-0 border-secondary p-4">
                            <div class="d-inline-flex align-items-center h-100">
                                <img src="img/story-1.jpg" class="img-fluid w-100 img-border" alt="Maratha Vivah Mandal, Dombivli">
                            </div>
                        </div>
                    </div> --}}
                </div>
